...
Immediate wake sources ignore those cadence limits: pointer input, key input, resize, exposure, native menu/notification/deep-link/drop work, ready futures, SSE activity, app requests, and split changes.
