...
| views/icons | 13.56% | 12.44% | +3.89 left, and blocked — gap #112 |
...
Three limits, filed as gap #110, and the second is the one that will bite
someone:
...
**The selected view's fill — gap #111.** It is 1.3px too tall and its corner
...
**The view icons' stroke — gap #112.** They carry 1.24–1.57x the reference's
