...
- **Class** — `FOOTGUN` (ours, not the library's — but see gap #99 for the half
...
`v` at 1.0 — at 25 sites in `icons.h` and `sidebar_system.h`. Filed as gap #99,
...
worth more than everything supersampling gains. Filed as gap #97. **It is not
...
helps every drawn shape and hurts every string.** Fixing gap #97 upstream would
