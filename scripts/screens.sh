...
capture_sized 18af_tooltip_narrow_split_dark "760 x 620" "$NARROW_SPLIT" HANABI_WIN_W=760 HANABI_WIN_H=620 HANABI_OPEN=r8 HANABI_SPLIT=t2 HANABI_TEST_TIP=composer_attach
...
capture_sized 35c_settings_narrow_shortcuts_dark "600 x 500" "$SET_NARROW_SHORTCUTS" HANABI_WIN_W=600 HANABI_WIN_H=500 HANABI_TEST_OVERLAY=settings
...
capture 63_ask_unanswerable_backend_dark "$TABS_DARK" \
    HANABI_ASK_DEMO=approval HANABI_ASK_NO_RESOLVE=1
...
capture 70_attachments_dark "$TABS_DARK" \
    "HANABI_DROP_TEST=$ROOT/tests/fixtures/attachments/sample.png;$ROOT/tests/fixtures/attachments/sample.md;$ROOT/tests/fixtures/attachments/sample.pdf"
capture 71_attachments_light "$TABS_LIGHT" \
    "HANABI_DROP_TEST=$ROOT/tests/fixtures/attachments/sample.png;$ROOT/tests/fixtures/attachments/sample.md;$ROOT/tests/fixtures/attachments/sample.pdf"
capture_sized 72_attachments_narrow_dark "760 x 620" "$NARROW_DARK" \
    HANABI_WIN_W=760 HANABI_WIN_H=620 \
    "HANABI_DROP_TEST=$ROOT/tests/fixtures/attachments/sample.png;$ROOT/tests/fixtures/attachments/sample.md;$ROOT/tests/fixtures/attachments/sample.txt;$ROOT/tests/fixtures/attachments/sample.pdf"
