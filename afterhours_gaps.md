...
### #95 — A capture cannot say where anything landed: the screenshot path emits pixels and nothing else, so every geometric fact about a frame is bisected back out of the PNG
